...
IMAGES = [
    ('F', models.FileField(verbose_name="Product's Picture", default='image.png'))
]
...
class Product(models.Model):
    ...
    currency = models.CharField(choices=CURRENCIES, max_length=10, default='#')
    picture = models.FileField(verbose_name="Product's Picture", default='image.png')
    picture_left = models.FileField(verbose_name="Side view(Right)", default='image.png')
    picture_right = models.FileField(verbose_name="Right view(Left)", default='image.png')
    picture_top = models.FileField(verbose_name="Top view", default='image.png')
    picture_buttom = models.FileField(verbose_name="Buttom view", default='image.png')
    def __str__(self):
...
class Cart(models.Model):
    product = models.ForeignKey(Product, on_delete=models.CASCADE)
    customer = models.ForeignKey(User, blank=True, max_length=50, on_delete=models.CASCADE, default=000)
    date = models.DateTimeField(verbose_name='Added on')

    def __str__(self):
        return '{} added by {} {} on {}'.format(self.product.name, self.customer.first_name, self.customer.last_name, self.date )
...
class Tutorial(models.Model):
    ...
    introduction =models.TextField(verbose_name='Introduction', max_length=200, default='Introduction')
...
class Comment(models.Model):
    ...
    replied_to = models.IntegerField(default=-1)
...
class Service(models.Model):
    ...
    currency = models.CharField(choices=CURRENCIES, max_length=10, default='#')
    images = models.FileField(verbose_name='Service images', default='images.png')
